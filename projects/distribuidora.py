...
class main(ThreeDScene):
    ...
    def construct(self):
        ...
        label_0.move_to(np.array([-0.5, -0.5, 0]))
        ...
        y_label.rotate(90 * DEGREES, axis = X_AXIS)
        y_label1.rotate(90 * DEGREES, axis = X_AXIS)
        y_label2.rotate(90 * DEGREES, axis = X_AXIS)
        y_label3.rotate(90 * DEGREES, axis = X_AXIS)
        y_label4.rotate(90 * DEGREES, axis = X_AXIS)
        y_label5.rotate(90 * DEGREES, axis = X_AXIS)
        self.play(
            Write(y_label)
        )
        self.add_fixed_orientation_mobjects(y_label, y_label1, y_label2, y_label3, y_label4, y_label5)
        y_labels.rotate(90 * DEGREES, axis = Y_AXIS)
        y_label.rotate(90 * DEGREES, axis = Z_AXIS)
        y_label1.rotate(90 * DEGREES, axis = Z_AXIS)
        y_label2.rotate(90 * DEGREES, axis = Z_AXIS)
        y_label3.rotate(90 * DEGREES, axis = Z_AXIS)
        y_label4.rotate(90 * DEGREES, axis = Z_AXIS)
        y_label5.rotate(90 * DEGREES, axis = Z_AXIS)
        ...
        z_label.rotate(90 * DEGREES, axis = X_AXIS)
        z_label1.rotate(90 * DEGREES, axis = X_AXIS)
        z_label2.rotate(90 * DEGREES, axis = X_AXIS)
        z_label3.rotate(90 * DEGREES, axis = X_AXIS)
        self.play(
            Write(z_label)
        )
        z_label.rotate(-90 * DEGREES, axis = X_AXIS)
