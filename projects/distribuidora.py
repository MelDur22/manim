...
class main(ThreeDScene):
    ...
    def construct(self):
        ...
        y_label.rotate(-90 * DEGREES, axis = Y_AXIS)
        y_label1.rotate(-90 * DEGREES, axis = Y_AXIS)
        y_label2.rotate(-90 * DEGREES, axis = Y_AXIS)
        y_label3.rotate(-90 * DEGREES, axis = Y_AXIS)
        y_label4.rotate(-90 * DEGREES, axis = Y_AXIS)
        y_label5.rotate(-90 * DEGREES, axis = Y_AXIS)
